...
awful.screen.connect_for_each_screen(function(s)
    ...
    local names = { "main", "dev", "learn", "social", "play", "6", "7", "8", "9" }
    ...
    s.mywibox:setup {
        expand = "none", -- Center the tasklist buttons, https://stackoverflow.com/a/48748286/346808
